...
export default function Testimonials() {
  return (
    <>
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <div className="max-w-[760px] mb-12">
            <p className="text-[12px] font-bold uppercase tracking-[0.16em] text-[#C02719]">Customer stories</p>
          ...
          <div className="grid lg:grid-cols-3 gap-5">
            {TESTIMONIALS.map((t) => (
              ...
              >
                <Quote className="w-6 h-6 text-[#C02719] mb-3" />
                ...
                <figcaption className="mt-3 leading-tight">
                  <div className="font-bold text-[14px] text-[#0F2C24]">{t.name}</div>
      ...
      >
        <div className="max-w-[1280px] mx-auto px-6 lg:px-10">
          <h2 className="text-center text-[14px] font-bold uppercase tracking-[0.16em] text-[#0F2C24] mb-7">
            Awards & recognition
          </h2>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {AWARDS.map((a) => (
              <div
                key={a.title}
                className="bg-white border border-[#EAE7DF] rounded-xl p-5 text-center hover:border-[#0F2C24] transition-colors"
              ...
              >
                ...
                <div className="mt-3 text-[13px] font-extrabold text-[#0F2C24] leading-snug">{a.title}</div>
